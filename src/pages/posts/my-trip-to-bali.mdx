...
export const meta = {
  ...
  summary: 'Some thoughts on Bali',
  changelog: {
    '2020-20-20': 'Made a few grammar fixes.'
  },
  tags: [
    'travel', 'asia', 'blog'
  ]
...
This is a test [link](/about) for intenal pages.
...
![bali-monkey](https://images.pexels.com/photos/3849168/pexels-photo-3849168.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260)
